          ...
          return (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
              ...
              <div className="relative overflow-hidden flex flex-col justify-center p-8 md:p-12">
                ...
                {/* Product Name */}
                <h3 
                  className="text-2xl md:text-4xl font-bold text-gray-900 dark:text-white mb-3 cursor-pointer hover:text-primary-600 dark:hover:text-primary-400 transition-colors"
                ...
                {product.price !== undefined && product.price > 0 && (
                  <div className="text-3xl md:text-5xl font-bold text-primary-600 dark:text-primary-400 mb-8">
                ...
                <div className="flex flex-col gap-4">
                  <button
                    ...
                    className="w-full px-6 py-4 bg-primary-600 text-white text-lg font-semibold rounded-xl hover:bg-primary-700 transition-all duration-200 flex items-center justify-center hover:scale-105 shadow-lg hover:shadow-xl"
                  >
                  ...
                  <button
                    ...
                    className="w-full px-6 py-4 bg-success-600 text-white text-lg font-semibold rounded-xl hover:bg-success-700 transition-all duration-200 flex items-center justify-center hover:scale-105 shadow-lg hover:shadow-xl"
                  >
