...
export default function ModernHeader({
  ...
  return (
    <>
      ...
      <div className="bg-primary-900 text-white text-center py-2 text-sm font-medium">
        <div className="max-w-7xl mx-auto px-4">
          🚚 Free Shipping on All Orders Over $100 • Fast Delivery • Best Prices Guaranteed
        </div>
      </div>
          ...
          <div className="hidden lg:block">
            <div className="flex items-center justify-between py-4">
              ...
              <div className="flex-shrink-0">
                <Logo className="h-12" width={200} height={200} priority={true} />
              </div>
