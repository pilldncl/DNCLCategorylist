-- Alternative approach: Create a dedicated rankings table
-- This approach maintains a separate table that gets updated whenever trending data changes

-- Create trending rankings table
...
CREATE INDEX idx_trending_rankings_total_score ON trending_rankings (total_score DESC);
CREATE INDEX idx_trending_rankings_rank ON trending_rankings (rank);
CREATE INDEX idx_trending_rankings_brand ON trending_rankings (brand);
CREATE UNIQUE INDEX idx_trending_rankings_product_id ON trending_rankings (product_id);
